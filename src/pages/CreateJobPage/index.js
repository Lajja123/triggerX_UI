            ...
            <div className="lg:col-span-1 space-y-8">
              <div className="bg-[#141414]  rounded-2xl p-8 border border-white/10 hover:border-white/20 transition-all duration-300">
                ...
                <h4 className="text-[#A2A2A2] leading-relaxed text-md">
                  ...
                  that automate smart contract executions and maintenance tasks
                  on various blockchain networks. It ensures that critical
                  operations are performed reliably and on time.
                </h4>
              </div>
